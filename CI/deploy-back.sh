...
RUN_CMD="cd $REMOTE_PATH && docker build -t ugc-back-candidate . && docker kill ugc-api || true && docker rm ugc-api || true && docker tag ugc-back-candidate ugc-back && docker run -d -p 5000:5000 --name ugc-api --network host ugc-back"
